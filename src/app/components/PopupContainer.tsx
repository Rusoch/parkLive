...
export const PopupContainer: React.FC<PopupContainerProps> = ({ children, onClose, className }) => {
  return (
    <div className="fixed inset-0 z-80 flex items-end justify-center">
      ...
      <div
        className={`relative w-full bg-bg-primary dark:bg-dark-bg-100 rounded-t-[16px] shadow-[0px_-4px_12px_rgba(0,0,0,0.1)] dark:shadow-[0px_-4px_12px_rgba(255,255,255,0.1)] p-[20px] pb-[24px] pt-[10px] h-[500px] mb-[8.5dvh] ${
          className || ""
        }`}
      >
